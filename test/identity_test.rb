...
class IdentityTest < Minitest::Test
  def test_resolves_current_user
    ...
    identity = BasecampAgentConnector::Basecamp::Identity.resolve(basecamp_cli: build_cli(runner))
  ...
  def test_resolves_a_named_profile
    ...
    identity = BasecampAgentConnector::Basecamp::Identity.resolve(basecamp_cli: build_cli(runner), profile: "clawdito")
