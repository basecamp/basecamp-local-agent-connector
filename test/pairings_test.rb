...
class PairingsTest < Minitest::Test
  ...
  def test_a_missing_or_malformed_file_reads_as_nobody_paired
    assert_empty @pairings.paired
    [ "not json", "[]", '{"paired": [], "pending": 3}', "null", '{"paired": {"300": "oops"}, "pending": {"300": null}}',
      '{"paired": {"300": {}}, "pending": {"300": {}}}', '{"paired": {"300": {"login": "", "id": "4242"}}, "pending": {"300": {"login": "marie"}}}' ].each do |contents|
      ...
      assert_nil BasecampAgentConnector::Pairings.new(path: @pairings.path).pending(300), contents
    end
  end
